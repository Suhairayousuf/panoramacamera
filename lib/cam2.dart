...
class PanoramaCamera extends StatefulWidget {
  const PanoramaCamera({Key? key}) : super(key: key);

  @override
  State<PanoramaCamera> createState() => _PanoramaCameraState();
}

class _PanoramaCameraState extends State<PanoramaCamera> {
  @override
